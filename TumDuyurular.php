...
<?php
	...
	$sorgu = mysqli_query($db,'SELECT COUNT(*) AS toplam FROM duyuru');
...
<div>
    ...
    <div class="col-md-12">
        ...
        <h3 style="font-weight:600; text-align: -ms-center; text-align: center; text-align: -webkit-center; text-align: -moz-center; text-align: -o-center; text-align: -khtml-center;"><b> Tüm Genel Duyurular </b></h3>
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div style="min-height:450px; text-align: -ms-center; text-align: center; text-align: -webkit-center; text-align: -moz-center; text-align: -o-center; text-align: -khtml-center;">
						...
						<?php						
					  	...
					  	$sorgu = mysqli_query($db,'SELECT * FROM duyuru d, akademikpersonel ap WHERE d.APersonelID=ap.APersonelID AND DurumTumDuyuru=1 ORDER BY d.Tarih DESC LIMIT '.$limit.','.$sayfada);//    '.$limit.', ' . $sayfada);
					...
					?>						   
						  ...
						  <?php  } }
								...
								if($sayfa != 1) echo '
									<a href="TumDuyurular.php?sayfa=1"><input type="button" value="İlk sayfa" class="btn btn-primary btn-lg"></a>
										';
								if($sayfa != 1) echo '
											<a href="TumDuyurular.php?sayfa='.($sayfa-1).'"><input type="button" value="Önceki" class="btn btn-primary btn-lg"></a>
										';
								if($sayfa != $toplam_sayfa) echo '
											<a href="TumDuyurular.php?sayfa='.($sayfa+1).'"><input type="button" value="Sonraki sayfa" class="btn btn-primary btn-lg"></a>
										';
								
								if($sayfa != $toplam_sayfa) echo '
											<a href="TumDuyurular.php?sayfa='.$toplam_sayfa.'"><input type="button" value="Son sayfa" class="btn btn-primary btn-lg"></a>
										';
