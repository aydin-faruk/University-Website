...
<div role="main" class="main">
    ...
    <div class="container">
        ...
        <div class="row">
		  ...
		  <hr class="tall" />
		  	        <h3 style="font-weight:600; text-align: -ms-center; text-align: center; text-align: -webkit-center; text-align: -moz-center; text-align: -o-center; text-align: -khtml-center;"><b> AKADEMİK PERSONEL </b></h3>
										...
										<div class="panel-heading">
											<h4 class="panel-title">
												<a class="accordion-toggle">
													<?php echo $satir["Unvan"]." ".$satir["Adi"]." ".$satir["Soyadi"]; ?>
												</a>
											</h4>
										</div>
													...
													<div class="col-md-12">
														<a href="<?php 
																if($satir["WebAdresi"]==null)
																			...
																			echo $satir["WebAdresi"]; ?>" target="_blank"><input type="button" value="Web Sitesi" class="btn btn-primary btn-lg btn-block"></a>									
													</div>
