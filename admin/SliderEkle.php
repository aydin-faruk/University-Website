    ...
    <div class="col-lg-12">
        <section class="panel" style="margin-top:30px;">
            ...
            <div class="panel-body">
                <form class="form-horizontal form-bordered" action="kontrol/sliderekle.php" method="post" enctype="multipart/form-data">
                    <div class="form-group" style="margin-top:30px;">
                        <label class="col-md-3 control-label" for="inputDefault">Resim Adı<font color="red">*</font> : </label>
                        <div class="col-md-6">
						<input type="text" name="resimAdi" class = "form-control input-lg">
                        </div>
                    </div> 
					...
					<div class="form-group" style="margin-top:30px;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="checkbox">
                                    <label>
										<input style="width:30px; height:30px;" type="checkbox" name="durum" checked>
									</label>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header" style="background-color:red;">
                ...
                <h4 class="modal-title">Slider Ekleme BAŞARISIZ..!</h4>
            </div>
