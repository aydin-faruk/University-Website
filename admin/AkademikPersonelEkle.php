    ...
    <div class="col-lg-12">
        <section class="panel">
            <header class="panel-heading">
                ...
                <h2 class="panel-title">Akademik Personel Ekle</h2>
            </header>
            <div class="panel-body">
                <form class="form-horizontal form-bordered" action="kontrol/akademikpersonelekle.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
							<input type="text" name="adi" class = "form-control input-lg" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="inputDefault">Soyadı<font color="red">*</font> : </label>
                        <div class="col-md-6">
                            <input type="text" name="soyadi" class = "form-control input-lg" />
                        </div>
                    </div>
					<div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="dahilitel" class = "form-control input-lg" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="inputDefault">E-Posta<font color="red">*</font> : </label>
                        <div class="col-md-6">
                            <input type="text" name="eposta" class = "form-control input-lg" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="inputDefault">Web Adresi : </label>
                        <div class="col-md-6">
                            <input type="text" name="webadresi" class = "form-control input-lg" />
                        </div>
                    </div>
					<div class="form-group">
                        <label class="col-md-3 control-label" for="inputDefault">Şifresi : </label>
                        <div class="col-md-6">
                            <input type="password" name="sifresi" class = "form-control input-lg" />
                        </div>
                    </div>
                   <div class="form-group">
                        <label class="col-md-3 control-label" for="inputDefault">Şifresi Tekrar: </label>
                        <div class="col-md-6">
                            <input type="password" name="sifresitekrar" class = "form-control input-lg" />
                        </div>
                    </div>
					 <div class="form-group">
                            <label class="col-md-3 control-label" for="inputSuccess">Yetkili mi? : </label>
                            <div class="col-md-6">
                                <div class="checkbox">
                                    <label>
										<input style="width:30px; height:30px;" type="checkbox" name="yetki" checked>										
									</label>
									<h6><b style="color:red; font-size:20px;">*</b> Bu alanı <b>onayladığınızda Sadece Duyuru ve Ders Notlarına ulaşacaktır.</b> Diğer alanlara ulaşamayacaktır.</h6>
									<h6><b>Onaylamazsanız sisteme giriş yapamayacaktır.</b></h6>
                                </div>
                            </div>
                        </div>
						...
						<div class="form-group">
                            <label class="col-md-3 control-label" for="inputSuccess">Tam Yetkili mi? : </label>
                            <div class="col-md-6">
                                <div class="checkbox">
                                    <label>
										<input style="width:30px; height:30px;" type="checkbox" name="tamyetki">
									</label>
									<h6><b style="color:red; font-size:20px;">*</b> Bu alanı <b>onayladığınızda Herşeye ulaşacaktır.</b></h6>
									<h6><b>Tüm personelleri görecektir. Ve hakkında işlem yapabilecektir.</b></h6>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-md-9 col-md-offset-3">
                                <button type="submit" name="ekle" class="btn btn-primary hidden-xs">Kaydet</button>
                                <button type="submit" name="ekle" class="btn btn-primary btn-block btn-lg visible-xs mt-lg">Kaydet</button>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header" style="background-color:red;">
                ...
                <h4 class="modal-title">Akademik Personel Ekleme BAŞARISIZ..!</h4>
            </div>
