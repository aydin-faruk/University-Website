...
<section class="panel">
    <header class="panel-heading">
        ...
        <h2 class="panel-title">Bölüm Duyuru İşlemleri</h2>
    </header>
    <div class="panel-body">
        <div class="row">            
                <div class="col-sm-6">
                    <div class="mb-md">
                        <a href="BolumDuyuruEkle.php">
            ...
            <thead>
                <tr>
					...
					<?php
						if($_SESSION['yetki']==1)
						{
							echo '<th>Yayınlayan</th>';
						}
					?>
                    <th>Tarih</th>
                    <th>Anasayfa'da</th>
                    <th>Tüm Duyurular'da</th>
                    <th>İşlem</th>
                </tr>
            </thead>
            <tbody>
					<?php
						...
						if($_SESSION['yetki']==1)
						{
							$sorgu = mysqli_query($db,"SELECT * FROM bolumduyuru d, akademikpersonel ap WHERE d.APersonelID=ap.APersonelID ORDER BY d.Tarih DESC");
						}
						else if($_SESSION['yetki']==2)
						{
							$sorgu = mysqli_query($db,"SELECT * FROM bolumduyuru d, akademikpersonel ap WHERE d.APersonelID=ap.APersonelID AND ap.APersonelID=".mysqli_real_escape_string($db,$_SESSION['id'])." ORDER BY d.Tarih DESC");
						}
                    ...
                    <tr class="gradeX">
						...
						if($_SESSION['yetki']==1)
						{
							echo '<td>'.$satir["Unvan"]." ".$satir["Adi"]." ".$satir["Soyadi"].'</td>';
						}
						?>
                        <td><?php echo date("d.m.Y", strtotime($satir["Tarih"])); ?></td>
                        <td>
							<?php 
								if($satir["DurumAnasayfa"]==1) echo "Yayında";
								if($satir["DurumAnasayfa"]==0) echo "Yayında Değil"; 		
							?>
						</td>
                        <td>
							<?php 
								if($satir["DurumTumDuyuru"]==1) echo "Yayında";
								if($satir["DurumTumDuyuru"]==0) echo "Yayında Değil"; 		
							?>
						</td>
                        <td class="actions">
                            <a href="BolumDuyuruGuncelle.php?id=<?php echo $satir['BolumDuyuruID']; ?>"><i style="font-size:25px; color:#016d2f;" class="fa fa-pencil"></i></a>                          
                            <a onclick="gonder(<?php echo $satir['BolumDuyuruID']; ?>)" data-toggle="modal" style="cursor:pointer;" class="on-default remove-row"><i style="font-size:25px; color:red;" class="fa fa-trash-o"></i></a>
                        </td>
                    </tr>
						<?php			
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="font-size:15px;">Duyuru, Başarılı Bir Şekilde Silindi.</p>
                </div>
    ...
    <div id="EModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="font-size:15px;">Duyuru, Başarılı Bir Şekilde Eklendi.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">TAMAM</button>
                </div>
    ...
    <div id="GModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="font-size:15px;">Duyuru, Başarılı Bir Şekilde Güncellendi.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">TAMAM</button>
                </div>
