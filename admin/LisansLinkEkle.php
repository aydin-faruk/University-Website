    ...
    <div class="col-lg-12">
        <section class="panel" style="margin-top:30px;">
            <header class="panel-heading">
                ...
                <h2 class="panel-title">Lisans Ekle</h2>
            </header>
            <div class="panel-body">
                <form class="form-horizontal form-bordered" action="kontrol/lisanslinkekle.php" method="post" enctype="multipart/form-data">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header" style="background-color:red;">
                ...
                <h4 class="modal-title">Lisans Ekleme BAŞARISIZ..!</h4>
            </div>
