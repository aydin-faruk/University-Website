    ...
    <div class="col-lg-12">
        <section class="panel" style="margin-top:30px;">
            <header class="panel-heading">
                ...
                <h2 class="panel-title">Etkinlik Güncelle</h2>
            </header>
            <div class="panel-body">
				...
				<?php
						...
						$sorgu = mysqli_query($db,"SELECT * FROM etkinlik where EtkinlikID=".$id."");
				...
				<form class="form-horizontal form-bordered" action="kontrol/etkinlikguncelle.php" method="post" enctype="multipart/form-data">
                   
					<div class="form-group" style="display: none;">
                        <label class="col-md-3 control-label" for="inputDefault">id :</label>
                        <div class="col-md-6">
							<input type="text" name="id" class = "form-control input-lg" value="<?php echo $satir['EtkinlikID'] ?>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="checkbox">
                                <label>
									<input style="width:30px; height:30px;" type="checkbox" name="TumAktif" <?php if($satir['DurumTumEtkinlik']==1) echo 'checked'?>>
                                </label>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header" style="background-color:red;">
                ...
                <h4 class="modal-title">Etkinlik Güncelleme BAŞARISIZ..!</h4>
            </div>
