        ...
        <section class="panel" style="margin-top:30px;">
            ...
            <div class="panel-body">
				...
				<?php
						...
						$sorgu = mysqli_query($db,"SELECT * FROM ogrenci where OgrenciID=".$id."");
				...
				<form class="form-horizontal form-bordered" action="kontrol/ogrenciguncelle.php" method="post" enctype="multipart/form-data">
