...
<div class="row">
  <section class="panel">
    <header class="panel-heading">
        ...
        <h2 class="panel-title">Ders Notları İşlemleri</h2>
    </header>
    <div class="panel-body">
        <div class="row">            
                <div class="col-sm-6">
                    <div class="mb-md">
                        <a href="DersNotEkle.php">
        ...
        <table class="table table-bordered table-striped mb-none" id="datatable-editable">
            ...
            <tbody>
					<?php
						...
						if($_SESSION['yetki']==1)
						{
							$sorgu = mysqli_query($db,"SELECT * FROM dersnot d, akademikpersonel ap WHERE d.APersonelID=ap.APersonelID ORDER BY d.Baslik ASC");
						}
						else if($_SESSION['yetki']==2)
						{
							$sorgu = mysqli_query($db,"SELECT * FROM dersnot d, akademikpersonel ap WHERE d.APersonelID=ap.APersonelID AND ap.APersonelID=".mysqli_real_escape_string($db,$_SESSION['id'])." ORDER BY d.Baslik ASC");
						}
                    ...
                    <tr class="gradeX">
                        ...
                        <td class="actions">
                            <a href="DersNotGuncelle.php?id=<?php echo $satir['DersNotID']; ?>"><i style="font-size:25px; color:#016d2f;" class="fa fa-pencil"></i></a>                          
                            <a onclick="gonder(<?php echo $satir['DersNotID']; ?>)" data-toggle="modal" style="cursor:pointer;" class="on-default remove-row"><i style="font-size:25px; color:red;" class="fa fa-trash-o"></i></a>
                        </td>
                    </tr>
						<?php			
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="font-size:15px;">Ders Notu, Başarılı Bir Şekilde Silindi.</p>
                </div>
    ...
    <div id="EModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="font-size:15px;">Ders Notu, Başarılı Bir Şekilde Eklendi.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">TAMAM</button>
                </div>
    ...
    <div id="GModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="font-size:15px;">Ders Notu, Başarılı Bir Şekilde Güncellendi.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">TAMAM</button>
                </div>
