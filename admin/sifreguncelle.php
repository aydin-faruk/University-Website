     ...
     <div class="col-lg-12">		
		<section class="panel">
            <header class="panel-heading">
                ...
                <h2 class="panel-title">Şifre Güncelle</h2>
            </header>
            <div class="panel-body">
			<?php
						$sorgu = mysqli_query($db,"SELECT * FROM akademikpersonel WHERE APersonelID=".mysqli_real_escape_string($db,$_SESSION['id']));
						
						if( mysqli_num_rows($sorgu) > 0 ){
						  // sonuc kumesini donelim
						 $satir = mysqli_fetch_assoc($sorgu); 
					?>
                <form class="form-horizontal form-bordered" action="kontrol/sifreguncelle.php" method="post">
					...
					<div class="form-group">
                        <label class="col-md-3 control-label" for="inputDefault">Eski Şifre : </label>
                        <div class="col-md-6">
                            <input type="password" name="esifre" class = "form-control input-lg" />
                        </div>
                    </div> 	
					...
					if($_GET['sd']=='no')
					{
						//echo '<p style="font-size:18px; color:red; text-align:center;"><b>Şifre değiştirme Başarısız. Eski ve yeni şifreyi tekrar giriniz.</b></p>'; 
					}
					?>
					...
					if($_GET['sd']=='yes')
					{
						//echo '<p style="color:green; font-size:18px; text-align:center;"><b>Şifre değiştirme Başarılı.</b></p>'; 
					}
					?>					
					<div class="form-group">
                        <label class="col-md-3 control-label" for="inputDefault">Yeni Şifre : </label>
                        <div class="col-md-6">
                            <input type="password" name="ysifre" class = "form-control input-lg" />
                        </div>
                    </div>                   
					<div class="form-group">
                        <label class="col-md-3 control-label" for="inputDefault">Yeni Şifre Tekrar : </label>
                        <div class="col-md-6">
                            <input type="password" name="ysifretekrar" class = "form-control input-lg"/>
                        </div>
                    </div>
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-md-9 col-md-offset-3">
                                <button type="submit" name="sifredegistir" class="btn btn-primary hidden-xs">Kaydet</button>
                                <button type="submit" name="sifredegistir" class="btn btn-primary btn-block btn-lg visible-xs mt-lg">Kaydet</button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                <div class="modal-header" style="background-color:#00aa4f;">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                     <h4 class="modal-title"><b>BAŞARILI!</b></h4>
                </div>
                <div class="modal-body">
                    <p>Şifre Güncelleme Başarılı..</p>
                </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header" style="background-color:red;">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                     <h4 class="modal-title"> <b>BAŞARISIZ..!</b></h4>
                </div>
                <div class="modal-body">
                    <p>Şifre Güncelleme Başarısız. Eski ve Yeni şifreleri tekrar  giriniz..</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">TAMAM</button>
                </div>
