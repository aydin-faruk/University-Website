        ...
        <section class="panel" style="margin-top:30px;">
            ...
            <div class="panel-body">
				...
				<?php
						...
						$sorgu = mysqli_query($db,"SELECT * FROM slayt where SlaytID=".$id."");
				...
				<form class="form-horizontal form-bordered" action="kontrol/sliderguncelle.php" method="post" enctype="multipart/form-data">
                   
					<div class="form-group" style="display: none;">
                        <label class="col-md-3 control-label" for="inputDefault">id :</label>
                        <div class="col-md-6">
							<input type="text" name="id" class = "form-control input-lg" value="<?php echo $satir['SlaytID'] ?>"/>
                        </div>
                    </div>
										
                     <div class="form-group" style="margin-top:30px;">
                        <label class="col-md-3 control-label" for="inputDefault">Resim Adı<font color="red">*</font> : </label>
                        <div class="col-md-6">
						<input type="text" name="resimAdi" class = "form-control input-lg" value="<?php echo $satir['ResimAdi'] ?>">
                        </div>
                    </div>  	
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                        <h6 style="color:red; font-weight:600;"> Kaliteli görüntü için lütfen resim boyutu <b style="font-size:15px;">1140x430 pixel </b> olsun. Resimleri atmadan önce, <b> PAİNT</b> programından bu boyutlara göre ayarlayınız.</h6>
					...
					<div class="form-group" style="margin-top:30px;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="checkbox">
                                    <label>
										<input style="width:30px; height:30px;" type="checkbox" name="durum" <?php if($satir['Durum']==1) echo 'checked'?>>
									</label>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header" style="background-color:red;">
                ...
                <h4 class="modal-title">Slider Güncelleme BAŞARISIZ..!</h4>
            </div>
            <div class="modal-body">
                <p>Kırmızı yıldız ile gösterilen zorunlu alanları doldurmanız gerekmektedir.</p>
				<p>Dosya isimlerinde Boşluk olmasın. ve sadece şu uzantılar olsun;</p>
