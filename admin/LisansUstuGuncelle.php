        ...
        <section class="panel" style="margin-top:30px;">
            ...
            <div class="panel-body">
				...
				<?php
						...
						$sorgu = mysqli_query($db,"SELECT * FROM lisansustu where LisansUstuID=".$id."");
				...
				<form class="form-horizontal form-bordered" action="kontrol/lisansustuguncelle.php" method="post" enctype="multipart/form-data">
