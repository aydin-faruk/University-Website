...
<section class="panel">
    <header class="panel-heading">
        ...
        <h2 class="panel-title">İdari Personel İşlemleri</h2>
    </header>
    <div class="panel-body">
        <div class="row">
            <div class="col-sm-6">
                <div class="mb-md">
                    <a href="idariPersonelEkle.php">
        ...
        <table class="table table-bordered table-striped mb-none" id="datatable-editable">
            ...
            <tbody>
					...
					?>                
                    <tr class="gradeX">
						<td><?php echo $satir["Gorev"]; ?></td>
                        <td><?php echo $satir["Unvan"]; ?></td>
                        <td><?php echo $satir["Adi"]." ".$satir["Soyadi"]; ?></td>
                        <td class="actions">
                            <a href="idariPersonelGuncelle.php?id=<?php echo $satir['IPersonelID']?>" class="on-default edit-row"><i style="font-size:25px; color:#016d2f;" class="fa fa-pencil"></i></a>
                            <a onclick="gonder(<?php echo $satir['IPersonelID']; ?>)" data-toggle="modal" style="cursor:pointer;" class="on-default remove-row"><i style="font-size:25px; color:red;" class="fa fa-trash-o"></i></a>
                        </td>
						<td>
							<?php if($satir["Sira"] != 1){ ?>
								<a href="kontrol/ipersonelsirala.php?islem=yukari&id=<?php echo $satir['IPersonelID']; ?>&sira=<?php echo $satir["Sira"]; ?>" ><img src="Content/images/yukari.png" alt="" style="width: 25px;" /></a>
							<?php } ?>
							
							<?php if($satir["Sira"] != mysqli_num_rows($sorgu)){ ?>
								<a href="kontrol/ipersonelsirala.php?islem=asagi&id=<?php echo $satir['IPersonelID']; ?>&sira=<?php echo $satir["Sira"]; ?>"><img src="Content/images/asagi.png" alt="" style="width: 25px;" /></a>
							<?php } ?>
						</td>
                    </tr>
						<?php } } ?>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="font-size:15px;">İdari Personel, Başarılı Bir Şekilde Silindi.</p>
                </div>
    ...
    <div id="EModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="font-size:15px;">İdari Personel, Başarılı Bir Şekilde Eklendi.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">TAMAM</button>
                </div>
    ...
    <div id="GModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="font-size:15px;">İdari Personel, Başarılı Bir Şekilde Güncellendi.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">TAMAM</button>
                </div>
...
<script>
        function gonder(DuyuruID) {
            $.ajax({
                type: "GET",
                url: "IPersonelSilModal.php",
                data: {ipersonelId: DuyuruID},
