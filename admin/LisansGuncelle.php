        ...
        <section class="panel" style="margin-top:30px;">
            ...
            <div class="panel-body">
				...
				<?php
						...
						$sorgu = mysqli_query($db,"SELECT * FROM lisans where LisansID=".$id."");
				...
				<form class="form-horizontal form-bordered" action="kontrol/lisansguncelle.php" method="post" enctype="multipart/form-data">
