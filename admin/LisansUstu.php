        ...
        <table class="table table-bordered table-striped mb-none" id="datatable-editable">
            ...
            <tbody>
					<?php
						...
						$sorgu = mysqli_query($db,"SELECT * FROM lisansustu ORDER BY Sira");
                    ...
                    <tr class="gradeX">
                        ...
                        <td class="actions">
                            <a href="LisansUstuGuncelle.php?id=<?php echo $satir['LisansUstuID']; ?>"><i style="font-size:25px; color:#016d2f;" class="fa fa-pencil"></i></a>                          
						...
						<td>
							<?php if($satir["Sira"] != 1){ ?>
								<a href="kontrol/lisansustusirala.php?islem=yukari&id=<?php echo $satir['LisansUstuID']; ?>&sira=<?php echo $satir["Sira"]; ?>" ><img src="Content/images/yukari.png" alt="" style="width: 25px;" /></a>
							<?php } ?>
							
							<?php if($satir["Sira"] != mysqli_num_rows($sorgu)){ ?>
								<a href="kontrol/lisansustusirala.php?islem=asagi&id=<?php echo $satir['LisansUstuID']; ?>&sira=<?php echo $satir["Sira"]; ?>"><img src="Content/images/asagi.png" alt="" style="width: 25px;" /></a>
							<?php } ?>
						</td>
                    </tr>
						<?php
