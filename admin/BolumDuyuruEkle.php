    ...
    <div class="col-lg-12">
        <section class="panel" style="margin-top:30px;">
            <header class="panel-heading">
                ...
                <h2 class="panel-title">Bölüm Duyuru Ekle</h2>
            </header>
            <div class="panel-body">
                <form class="form-horizontal form-bordered" action="kontrol/bolumduyuruekle.php" method="post" enctype="multipart/form-data">
                   
                     <div class="form-group" style="margin-top:30px;">
                        <label class="col-md-3 control-label" for="inputDefault">Başlık<font color="red">*</font> : </label>
                        <div class="col-md-6">
						<input type="text" name="baslik" class = "form-control input-lg">
                        </div>
                    </div>               
                                         

                    <div class="form-group" style="margin-top:30px;">
                        <label class="col-md-3 control-label">Tarih<font color="red">*</font> : </label>
                        <div class="col-md-6">
                            <div class="input-group">
                                <span class="input-group-addon">
                                    <i class="fa fa-calendar"></i>
                                </span>
								<input type="text" name="tarih" class = "form-control input-lg" placeholder = "__/__/____", id = "example1" value="<?php echo date('Y-m-d'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
								 <textarea type="text" name="aciklama" class = "form-control", rows = "7", id = "editor1"></textarea>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="inputSuccess">Anasayfa'da Aktif mi? : </label>
                            <div class="col-md-6">

                                <div class="checkbox">
                                    <label>
										<input style="width:30px; height:30px;" type="checkbox" name="AnaAktif" checked>
									</label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="inputSuccess">Tüm Bölüm Duyurular'da Aktif mi? : </label>
                        <div class="col-md-6">

                            <div class="checkbox">
                                <label>
									<input style="width:30px; height:30px;" type="checkbox" name="TumAktif" checked>
                                </label>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header" style="background-color:red;">
                ...
                <h4 class="modal-title">Duyuru Ekleme BAŞARISIZ..!</h4>
            </div>
