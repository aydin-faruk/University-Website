        ...
        <header class="header">
            ...
            <section role="main" class="content-body">
                <header class="page-header">
                    <h2>Akademik Personel Güncelle</h2>
...
<div class="row">
    <div class="col-lg-12">
        <section class="panel">
			...
			<?php
						$id=$_GET['id'];
						$sorgu = mysqli_query($db,"SELECT * FROM akademikpersonel where APersonelID=".$id."");
						
						if( mysqli_num_rows($sorgu) > 0 ){
						  // sonuc kumesini donelim
						 $satir = mysqli_fetch_assoc($sorgu); 
					?>
                <form class="form-horizontal form-bordered" action="kontrol/akademikpersonelguncelle.php" method="post" enctype="multipart/form-data">
                    
					<div class="form-group" style="display: none;">
                        <label class="col-md-3 control-label" for="inputDefault">id :</label>
                        <div class="col-md-6">
							<input type="text" name="id" class = "form-control input-lg" value="<?php echo $satir["APersonelID"] ?>"/>
                        </div>
                    </div>
					...
					<div class="form-group">
                        ...
                        <div class="col-md-6" style="color:red;">
							<h6><b>Güvenlik sebebi</b> ile kullanıcıların şifrelerini güncelleyemezsiniz.</h6>
							<h6><b>Personel şifre ile ilgili problem yaşıyorsa; Mevcut personeli silin ve yeniden ekleyiniz.</b></h6>
                        </div>
                    </div>                   
					 <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="checkbox">
                                    <label>
										<input style="width:30px; height:30px;" type="checkbox" name="yetki" <?php if($satir['Yetki']==1) echo 'checked'?>>
									</label>
									<h6><b style="color:red; font-size:20px;">*</b> Bu alanı <b>onayladığınızda <b>Sadece</b> Duyuru ve Ders Notlarına ulaşacaktır.</b> Diğer alanlara ulaşamayacaktır.</h6>
						...
						<div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="checkbox">
                                    <label>
										<input style="width:30px; height:30px;" type="checkbox" name="tamyetki" <?php if($satir['TamYetki']==1) echo 'checked'?>>
									</label>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header" style="background-color:red;">
                ...
                <h4 class="modal-title">Akademik Personel Güncelleme BAŞARISIZ..!</h4>
            </div>
