    ...
    <div class="col-lg-12">
        <section class="panel" style="margin-top:30px;">
            <header class="panel-heading">
                ...
                <h2 class="panel-title">Misyon ve Vizyon Güncelle</h2>
            </header>
            <div class="panel-body">
			
				<?php						
						
						$sorgu = mysqli_query($db,"SELECT * FROM misyonvizyon where MisyonVizyonID=1");
				...
				<form class="form-horizontal form-bordered" action="kontrol/misyonvizyonguncelle.php" method="post" enctype="multipart/form-data">
                   
					<div class="form-group" style="display: none;">
                        <label class="col-md-3 control-label" for="inputDefault">id :</label>
                        <div class="col-md-6">
							<input type="text" name="id" class = "form-control input-lg" value="<?php echo $satir['MisyonVizyonID'] ?>"/>
                        </div>
                    </div>
					
					<div class="form-group">
                            <label class="col-md-3 control-label" for="inputDefault">Misyon<font color="red">*</font> : </label>
                            <div class="col-md-6">
								 <textarea type="text" name="maciklama" class = "form-control", rows = "7", id = "editor1"><?php echo $satir['Misyon'] ?></textarea>
						...
						<div class="form-group">
                            <label class="col-md-3 control-label" for="inputDefault">Vizyon<font color="red">*</font> : </label>
                            <div class="col-md-6">
								 <textarea type="text" name="vaciklama" class = "form-control", rows = "7", id = "editor2"><?php echo $satir['Vizyon'] ?></textarea>
                                <script type="text/javascript" src="scripts/jquery-3.1.0.min.js"></script>
                                <script src="ckeditor/ckeditor.js"></script>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="font-size:15px;">Misyon ve Vizyon , Başarılı Bir Şekilde Güncellendi.</p>
                </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header" style="background-color:red;">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Misyon ve Vizyon Güncelleme BAŞARISIZ..!</h4>
            </div>
            <div class="modal-body">
