    ...
    <div class="col-lg-12">
        <section class="panel" style="margin-top:30px;">
            <header class="panel-heading">
                ...
                <h2 class="panel-title">Bölüm Duyuru Güncelle</h2>
            </header>
            <div class="panel-body">
				...
				<form class="form-horizontal form-bordered" action="kontrol/bolumduyuruguncelle.php" method="post" enctype="multipart/form-data">
                   
					<div class="form-group" style="display: none;">
                        <label class="col-md-3 control-label" for="inputDefault">id :</label>
                        <div class="col-md-6">
							<input type="text" name="id" class = "form-control input-lg" value="<?php echo $satir['BolumDuyuruID'] ?>"/>
                        </div>
                    </div>
