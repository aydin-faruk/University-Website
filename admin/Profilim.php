     ...
     <div class="col-lg-12">
        <section class="panel">
            <header class="panel-heading">
                ...
                <h2 class="panel-title">Profil Güncelle</h2>
            </header>
			...
			<?php
					...
					?>
                <form class="form-horizontal form-bordered" action="kontrol/profilguncelle.php" method="post" enctype="multipart/form-data">
					...
					if($_SESSION['id']!=5)
					{
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input type="text" name="adi" class = "form-control input-lg" value="'.$satir["Adi"].'"/>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-3 control-label" for="inputDefault">Soyadı<font color="red">*</font> : </label>
							<div class="col-md-6">
								<input type="text" name="soyadi" class = "form-control input-lg" value="'.$satir["Soyadi"].'" />
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input type="text" name="dahilitel" class = "form-control input-lg" value="'.$satir["DahiliTel"].'" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-3 control-label" for="inputDefault">Web Adresi : </label>
							<div class="col-md-6">
								<input type="text" name="webadresi" class = "form-control input-lg" value="'.$satir["WebAdresi"].'"/>
							</div>
						</div>
						';
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-md-9 col-md-offset-3">
                                <button type="submit" name="profil" class="btn btn-primary hidden-xs">Kaydet</button>
                                <button type="submit" name="profil" class="btn btn-primary btn-block btn-lg visible-xs mt-lg">Kaydet</button>
                            </div>
                        </div>
                    </div>
    ...
    <div id="GModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="font-size:15px;">Profiliniz, Başarılı Bir Şekilde Güncellendi.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">TAMAM</button>
                </div>
