...
<section class="panel">
    <header class="panel-heading">
        ...
        <h2 class="panel-title">Etkinlik İşlemleri</h2>
    </header>
 <div class="panel-body">
        <div class="row">            
                <div class="col-sm-6">
                    <div class="mb-md">
                        <a href="EtkinlikEkle.php">
        ...
        <table class="table table-bordered table-striped mb-none" id="datatable-editable">
            ...
            <tbody>
					<?php
						...
						$sorgu = mysqli_query($db,"SELECT * FROM etkinlik ORDER BY Tarih DESC");
                    ...
                    <tr class="gradeX">
                        ...
                        <td>
							<?php 
								if($satir["DurumTumEtkinlik"]==1) echo "Yayında";
								if($satir["DurumTumEtkinlik"]==0) echo "Yayında Değil"; 		
							?>
						</td>
                        <td class="actions">
                            <a href="EtkinlikGuncelle.php?id=<?php echo $satir['EtkinlikID']; ?>"><i style="font-size:25px; color:#016d2f;" class="fa fa-pencil"></i></a>                          
                            <a onclick="gonder(<?php echo $satir['EtkinlikID']; ?>)" data-toggle="modal" style="cursor:pointer;" class="on-default remove-row"><i style="font-size:25px; color:red;" class="fa fa-trash-o"></i></a>
                        </td>
                    </tr>
						<?php
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="font-size:15px;">Etkinlik, Başarılı Bir Şekilde Silindi.</p>
                </div>
    ...
    <div id="EModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="font-size:15px;">Etkinlik, Başarılı Bir Şekilde Eklendi.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">TAMAM</button>
                </div>
    ...
    <div id="GModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="font-size:15px;">Etkinlik, Başarılı Bir Şekilde Güncellendi.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">TAMAM</button>
                </div>
