    ...
    <div class="col-lg-12">
        <section class="panel" style="margin-top:30px;">
            <header class="panel-heading">
                ...
                <h2 class="panel-title">Olanak Güncelle</h2>
            </header>
            <div class="panel-body">
				...
				<?php
						...
						$sorgu = mysqli_query($db,"SELECT * FROM olanaklar where OlanakID=".$id."");
				...
				<form class="form-horizontal form-bordered" action="kontrol/olanakguncelle.php" method="post" enctype="multipart/form-data">
                   
					<div class="form-group" style="display: none;">
                        <label class="col-md-3 control-label" for="inputDefault">id :</label>
                        <div class="col-md-6">
							<input type="text" name="id" class = "form-control input-lg" value="<?php echo $satir['OlanakID'] ?>"/>
                        </div>
                    </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header" style="background-color:red;">
                ...
                <h4 class="modal-title">Olanak Güncelleme BAŞARISIZ..!</h4>
            </div>
