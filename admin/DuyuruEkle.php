    ...
    <div class="col-lg-12">
        <section class="panel" style="margin-top:30px;">
            <header class="panel-heading">
                ...
                <h2 class="panel-title">Genel Duyuru Ekle</h2>
            </header>
            <div class="panel-body">
                <form class="form-horizontal form-bordered" action="kontrol/duyuruekle.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group" style="margin-top:30px;">
                        <label class="col-md-3 control-label">Yayın Tarih<font color="red">*</font> : </label>
                        <div class="col-md-6">
					...
					<div class="form-group" style="margin-top:30px;">
                        <label class="col-md-3 control-label">Son Yayın Tarihi<font color="red">*</font> : </label>
                        <div class="col-md-6">
                            <div class="input-group">
                                <span class="input-group-addon">
                                    <i class="fa fa-calendar"></i>
                                </span>
								<input type="text" name="sontarih" class = "form-control input-lg" placeholder = "__/__/____", id = "example2">
                                <!-- Load jQuery and bootstrap datepicker scripts -->
                                <script src="scripts/jquery-3.1.0.min.js"></script>
                                <script src="Content/vendor/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
                                <script type="text/javascript">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="checkbox">
                                    <label>
										<input style="width:30px; height:30px;" type="checkbox" name="AnaAktif">
									</label>
                                </div>
                            </div>
                        </div>
